          ...
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              ...
              <div className="flex mt-6 -mx-2">
                <a
                  href="#"
                  className="mx-2 text-slate-300 transition-colors duration-300 hover:text-white"
                  aria-label="Reddit"
                >
                  <svg
          ...
          <div className="mt-6 lg:mt-0 lg:flex-1">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              <div>
                ...
                <a
                  href="#"
                  className="block mt-2 text-sm text-slate-300 hover:underline"
                >
                  Company
                </a>
                <a
              ...
              <div>
                ...
                <span className="block mt-2 text-sm text-slate-300 hover:underline">
                  +1 526 654 8965
                </span>
                <span className="block mt-2 text-sm text-slate-300 hover:underline">
                  example@email.com
